...
{
    public class D_PACIENTE_HISTORIAL
    {
        ...
        public D_PACIENTE_HISTORIAL() { }

        public D_PACIENTE_HISTORIAL(int codi, DateTime fec, string descipn, string esta) {
            this.CODIGO_PACIENTE = codi;
            this.FECHA = fec;
            this.DESCRIPCION = descipn;
            this.ESTADO = esta;
        }
        ...
        public DataTable Listar()
        {
            ...
            try
            {
                sqlconex.ConnectionString = Conexion.Conexion_bd;
                sqlcmd.Connection = sqlconex;
                sqlcmd.CommandText = "PACIENTE_HISTORIAL_MOSTRAR";
                sqlcmd.CommandType = CommandType.StoredProcedure;
